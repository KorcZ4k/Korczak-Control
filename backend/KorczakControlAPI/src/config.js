function loadConfig() {
  ...
  return Object.freeze({
    ...
    tensuraDbUri,
    kzSiteDbUri,
    adminDbName: process.env.ADMIN_DB_NAME || 'Admin',
    tensuraDbName: process.env.TENSURA_DB_NAME || 'MoonTensura',
    kzSiteDbName: process.env.KZSITE_DB_NAME || 'KorczakTechSite',
